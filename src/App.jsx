...
function App() {
  const SpotifySVG = (props) => (
    <svg className="instagram-gradient" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 2931 2931">
      <defs>
  ...
  return (
    <>
      <div>
        ...
        <LemonDaysBanner />
        <motion.div className='mainGrid' variants={container} initial="hidden" animate="show"  >
          <motion.div variants={item} className='logoLink' whileHover={{scale: 1.05}}>
            <LogoLink icon={<Instagram className='instagram-gradient' />} title={"Instagram"} link={'https://www.instagram.com/le.mondays/'}  />
          </motion.div>
      
      <motion.div variants={item} className='logoLink' whileHover={{scale: 1.05}}>
      <LogoLink icon={<SpotifySVG />} title={"Spotify"} link={'https://open.spotify.com/track/1aR6nOZDJAiFdH4eXI56dJ'} />
       </motion.div>
      
       <motion.div variants={item}  whileHover={{scale: 1.05}} className='logoLink'><LogoLink icon={<Youtube fill='red'/>} title={"Youtube"} link={'https://www.youtube.com/@Le.Mondays'}  /> </motion.div>
       <motion.div variants={item} whileHover={{scale: 1.05}} className='logoLink'><LogoLink icon={<Twitter fill='#1DA1F2' color='#1DA1F2'/>} title={'Twitter'} link={'https://twitter.com/le_mondays'}  /> </motion.div>
